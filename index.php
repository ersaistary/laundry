<?php 
    ...
    if(isset($_POST['email'])){
        ...
        // }else if($role == 8){
        //     $queryLogin = mysqli_query($config, "SELECT * FROM students WHERE email = '$email' && password = '$password'");
        // }else{
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Swiftwash</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Swiftwash! 👋</h4>
              <p class="mb-4">Login in to your account and experience the swift, spotless touch of Swiftwash</p>
